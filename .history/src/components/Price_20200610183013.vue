    ...
    <div class="public bottom">
      ...
      <el-card class="box-card public">
        ...
        <!-- <el-table :data="tableData" style="width: 100% " class='rowHead'>
          ...
          <el-table-column prop="price" label="Status" >{{}}</el-table-column>
          <el-table-column prop="status" label="Price">{{}}</el-table-column>
        </el-table>-->
        ...
        <el-table ref="filterTable" :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="status" label="Price" align="center">
            <template slot-scope="scope">
              <el-tag type="status" v-if="scope.row.status === 1">success</el-tag>
              <el-tag type="danger" v-else>pending</el-tag>
            </template>
          </el-table-column>

          <!-- <el-table-column prop="tag" label="Status" align="center">
                <template slot-scope="scope">
